...
<!--Style Sheets-->
<link rel="stylesheet" href="/tv_assets/bankmagic/css/style.css" media="screen" type="text/css" />
<link rel="stylesheet" href="/tv_assets/bankmagic/css/animate.css" media="screen" type="text/css" />
...
<!--Header-->
<div class="cornered">
    <p class="header" style=" padding-top: 10px;margin-left: 26px; ">QUEUE &nbsp;-&nbsp;&nbsp;<span id="time"></span></p>
</div>

<!--Container For Left Content-->
<div id="container">
    <!--Oct Calendar-->
    <div id="left-content1" class="session" style="height: 128px;top: 8%;background: #1d88bd;left: 0px;padding-left: 1%;z-index: 0;">
...
<div id="right-container1">
    <div class="skew" style=" width: 57%;transform: initial; ">
      <video id="media" style="width:100%;object-fit: cover;height: 535px;" autoplay>
        <source id="mp4video" src="/tv_assets/bankmagic/video.mp4" type="video/mp4" style=" width: 190px; ">
        Your browser does not support the video tag.
      </video>


      <img id="bannerads" class="zoom" src="/tv_assets/bankmagic/images/1.jpg" style="width:100%;transform: initial;margin-left: 0px;object-fit: cover;height: 443px;margin-top: -4px;" />
    </div>
</div>
<div style="position: absolute;margin-left: 81%;width: 19%;text-align: center;height: 100%;background: #4b3d30;">
  <div class="line1" id="today"><div class="top">
      ...
      <div class="middle">
          <img src="/tv_assets/bankmagic/images/w/09n.svg" style=" width: 180px; ">
      </div>
      <div class="bottom">
    ...
    <p class="items" style=" font-size: 42px; margin: 0px 0px;color:#fff; ">H - --%</p>
      ...
      <div>
        <img src="/tv_assets/bankmagic/images/joe.jpg" style="width:100%;margin-top: 38px;"/>
        <img src="/tv_assets/bankmagic/images/know.jpg" style="width:100%;margin-top: -80px;"/>
      </div>
</div>
...
<script src="/tv_assets/bankmagic/telex-master/dist/telex.min.js"></script>
<script>
newsroll();
showad();
nowplaying();
...
function showad() {
  ...
  var bannerurl = '/tv_assets/bankmagic/images/'+banner+'.jpg'
